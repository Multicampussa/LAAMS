...
const NoticeAll = ({data}) => {
  ...
  const handleSend = useCallback((e)=>{
    ws.current.send("/app/chat/message/notice",{'Authorization': `Bearer ${accessToken}`}, JSON.stringify({type:'TALK', roomId:data.roomId, sender:null, roomName:data.roomName ,message}));
    setMessage("");
